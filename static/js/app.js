...
(function() {
    ...
    function readSelectedMultiQuizType() {
        ...
        return active ? active[0] : 'classic';
    }
    ...
    window.showCreateMulti = function() {
        ...
        if (typeof window.selectMultiQuizType === 'function') {
...
window.selectMultiQuizType = function(type) {
        ...
        try { if (typeof selectedQuizType !== 'undefined' && selectedQuizType) selectedQuizType.multi = nextType; } catch (e) {}
        window.selectedMultiQuizType = nextType;
        const buttons = {
            classic: document.getElementById('quizTypeClassic'),
            speed: document.getElementById('quizTypeSpeed'),
            picguess: document.getElementById('quizTypePicguess'),
        ...
        const target = buttons[nextType] || buttons.classic;
        ...
        if (hint) {
            ...
            hint.textContent = (hints[lang][nextType] || hints[lang].classic);
        }
    };
